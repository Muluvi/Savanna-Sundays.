...
const checklistItems = [
  { label: "Branded Venues", desc: "Visual dominance at host venues.", icon: <ShieldCheck size={24} />, color: "gold" },
  { label: "Squad Activation", desc: "Live DJs, MC, and influencers.", icon: <Zap size={24} />, color: "gold" },
  { label: "Music Harvest", desc: "High-fidelity YouTube DJ sets.", icon: <Music size={24} />, color: "gold" },
  { label: "Social Content", desc: "Optimised Reels for all platforms.", icon: <Video size={24} />, color: "gold" },
  { label: "HD Photography", desc: "Lifestyle assets harvested weekly.", icon: <Camera size={24} />, color: "gold" },
  { label: "Data Capture", desc: "QR competitions for KWAL CRM.", icon: <QrCode size={24} />, color: "gold" }
];
