        ...
        <Table className="w-full">
          <TableHeader className="bg-brand-gold">
            <TableRow className="border-none hover:bg-brand-gold">
              <TableHead className="text-brand-green font-headline tracking-[4px] py-6 px-6 md:px-10 text-[var(--text-sm)] uppercase">Breakdown</TableHead>
              <TableHead className="text-brand-green font-headline tracking-[4px] text-right px-6 md:px-10 text-[var(--text-sm)] uppercase">KSh</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {lineItems.map((row, i) => (
              ...
              >
                <TableCell className="font-body font-bold text-[10px] md:text-[var(--text-sm)] py-6 px-6 md:px-10 text-brand-cream/90 uppercase tracking-[2px] leading-relaxed">
                  {row.item}
                </TableCell>
                <TableCell className="font-headline text-[var(--text-xl)] md:text-[var(--text-2xl)] text-brand-gold text-right px-6 md:px-10">
                  {row.cost}
                </TableCell>
              </TableRow>
            ))}
            ...
            <TableRow className="bg-brand-gold/[0.12] border-y border-brand-gold/30 hover:bg-brand-gold/20 transition-colors">
              <TableCell className="font-headline text-[var(--text-2xl)] md:text-[var(--text-4xl)] py-8 px-6 md:px-10 text-brand-gold uppercase tracking-tighter">
                Weekly total
              </TableCell>
              <TableCell className="font-headline text-[var(--text-4xl)] md:text-[var(--text-6xl)] text-brand-gold text-right px-6 md:px-10 tracking-tighter">
