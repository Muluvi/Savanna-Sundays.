  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-fade-in-up [animation-delay:400ms]">
        <Card className="bg-white/5 border-l-4 border-red-500/50 p-6 group hover:bg-white/10 transition-all cursor-default">
        ...
        <Card className="bg-white/5 border-l-4 border-brand-gold/50 p-6 group hover:bg-white/10 transition-all cursor-default">
