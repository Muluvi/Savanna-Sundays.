  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-fade-in-up">
        <Card className="p-4 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-4 text-brand-cream group hover:bg-white/10 transition-all">
          <div className="w-10 h-10 rounded-full bg-brand-gold/20 text-brand-gold flex items-center justify-center shrink-0">
            <Users size={20} />
          </div>
          <div>
            <div className="font-headline text-2xl leading-none">300,000+</div>
            <div className="font-body text-[9px] uppercase tracking-[2px] opacity-40 mt-1 font-bold">Weekly Decision Makers</div>
          </div>
        </Card>
        
        <Card className="p-4 bg-white/5 border border-white/10 rounded-2xl flex items-center gap-4 text-brand-cream group hover:bg-white/10 transition-all">
          <div className="w-10 h-10 rounded-full bg-brand-teal/20 text-brand-teal flex items-center justify-center shrink-0">
            <MessageSquare size={20} />
          </div>
          <div>
            <div className="font-headline text-2xl leading-none">WhatsApp First</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-fade-in-up [animation-delay:400ms]">
        <Card className="bg-white/5 border-l-4 border-red-500/50 p-6 group hover:bg-white/10 transition-all">
          <div className="w-10 h-10 rounded-full bg-red-500/10 text-red-400 flex items-center justify-center mb-4">
            <AlertTriangle size={20} />
          </div>
          <h4 className="font-headline text-xl mb-2 text-brand-cream uppercase tracking-tight">The Fragmentation Problem</h4>
        ...
        <Card className="bg-white/5 border-l-4 border-brand-gold/50 p-6 group hover:bg-white/10 transition-all">
          <div className="w-10 h-10 rounded-full bg-brand-gold/10 text-brand-gold flex items-center justify-center mb-4">
            <XCircle size={20} />
          </div>
          <h4 className="font-headline text-xl mb-2 text-brand-cream uppercase tracking-tight">Savanna's Current Position</h4>
          <p className="font-body text-brand-cream/50 text-xs leading-relaxed">
