    ...
    <div ref={sectionRef} className="space-y-16 py-8 relative overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 items-start">
        <div className="space-y-8">
          <p className="font-body text-lg md:text-2xl text-[#1A1208] leading-relaxed border-l-4 border-brand-gold pl-8 py-2">
          ...
          <p className="font-body text-lg md:text-xl text-[#1A1208]/80 leading-relaxed opacity-90 pl-8">
        ...
        <div className="relative group">
          ...
          <div className="relative p-10 bg-white border border-brand-gold/10 rounded-[40px] shadow-2xl space-y-6">
            <span className="font-headline text-brand-green/60 text-xs tracking-[4px] uppercase font-bold">The Strategic Reality</span>
      ...
      <div className="mt-12 bg-[#FDF8EC] rounded-[40px] p-8 md:p-12 border border-brand-gold/20 shadow-xl overflow-hidden relative">
        ...
        <div className="relative z-10 space-y-8">
          <div className="section-label text-brand-green/60 mb-4">Savanna Kenya Right Now</div>
