  ...
  return (
    <div className="relative space-y-12 md:space-y-24 py-8 md:py-12">
      ...
      <div className="relative z-10 space-y-24">
        ...
        {/* 07B: The Agency Moat */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start animate-fade-in-up">
          ...
          <Card className="p-10 bg-white/5 border border-white/10 rounded-[40px] space-y-8 shadow-2xl backdrop-blur-md">
            <div className="flex items-center gap-4">
              ...
              <h5 className="font-headline text-3xl text-white uppercase leading-none">The Value Shift</h5>
            </div>
           ...
           {[
             ...
             <Card key={i} className="p-8 bg-white/5 border border-white/10 rounded-[32px] flex flex-col items-center text-center gap-4 group hover:bg-white/10 transition-all">
                ...
                <div>
                  ...
                  <p className="font-body text-xs text-brand-cream/40 font-bold uppercase tracking-widest">{moat.desc}</p>
                </div>
             </Card>
           ))}
        </div>
        ...
        {/* Final Closure */}
        <div className="flex flex-col items-center gap-12 pt-16 animate-fade-in-up [animation-delay:800ms]">
