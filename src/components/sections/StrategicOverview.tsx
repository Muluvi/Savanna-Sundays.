...
export const StrategicOverview = () => {
  return (
    <div className="space-y-24">
      {/* Intro Narrative */}
      <div className="space-y-8 max-w-[680px] animate-fade-in-up">
      ...
      {/* Pull Quote */}
      <div className="relative py-20 text-center flex items-center justify-center min-h-[300px] animate-fade-in-up [animation-delay:200ms]">
      ...
      {/* Narrative Part 2 */}
      <div className="space-y-8 max-w-[680px] animate-fade-in-up [animation-delay:400ms]">
        <p className="font-body text-[15px] text-brand-cream/60 leading-[1.7]">
      ...
      {/* Ecosystem Diagram */}
      <div className="py-12 flex flex-col items-center animate-fade-in-up [animation-delay:800ms]">
