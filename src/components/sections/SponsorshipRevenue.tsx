        ...
        <Table>
          <TableHeader className="bg-brand-gold">
            <TableRow className="hover:bg-transparent border-none">
              <TableHead className="text-brand-green font-headline tracking-widest py-6 px-10 text-xl uppercase">
                Tactical breakdown
              </TableHead>
              <TableHead className="text-brand-green font-headline tracking-widest text-right px-10 text-xl uppercase">
                KSh
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {lineItems.map((row, i) => (
              ...
              >
                <TableCell className="font-body font-bold text-sm md:text-base py-5 px-10 text-brand-cream/80">
                  {row.item}
                </TableCell>
                <TableCell className="font-headline text-3xl text-brand-cream text-right px-10">
                  {row.cost}
                </TableCell>
              </TableRow>
            ))}
            ...
            <TableRow className="bg-white/5 border-t-2 border-white/10">
              <TableCell className="font-headline text-2xl py-8 px-10 text-brand-gold/60">
                Activation subtotal
              </TableCell>
              <TableCell className="font-headline text-4xl text-brand-gold/60 text-right px-10">
                289,800
              </TableCell>
            </TableRow>

            <TableRow className="bg-brand-green/30">
              <TableCell className="font-body font-bold text-base py-8 px-10 text-brand-gold">
                Firefly agency fee (16%)
              </TableCell>
              <TableCell className="font-headline text-4xl text-brand-gold text-right px-10">
                46,368
              </TableCell>
            </TableRow>

            <TableRow className="bg-brand-gold text-brand-green">
              <TableCell className="font-headline text-4xl md:text-6xl py-10 px-10 uppercase tracking-tighter">
                Weekly total
              </TableCell>
              <TableCell className="font-headline text-5xl md:text-8xl text-right px-10 tracking-tighter">
                336,168
              </TableCell>
            </TableRow>
          </TableBody>
        ...
        {projections.map((p, i) => (
          <div key={i} className="p-10 bg-white/5 border border-white/10 rounded-[48px] space-y-8 flex flex-col justify-between group hover:border-brand-gold/40 transition-all duration-700">
            <div className="space-y-6">
              <div className="w-16 h-16 rounded-2xl bg-brand-gold/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                {p.icon}
              </div>
              ...
              <div className="space-y-1">
                ...
                <p className="font-body text-[10px] text-white/40 font-bold uppercase tracking-[5px]">{p.weeklySub}</p>
              </div>
            </div>
            
            <div className="pt-8 border-t border-white/10">
              <p className="font-body text-[11px] text-brand-gold uppercase tracking-[4px] font-bold mb-1">Monthly budget</p>
