    ...
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="space-y-4 animate-fade-in-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4">
          <Card className="p-5 bg-white border border-brand-green/5 rounded-[24px] space-y-2 hover:border-brand-gold transition-all shadow-sm">
          ...
          <Card className="p-5 bg-white border border-brand-green/5 rounded-[24px] space-y-2 hover:border-brand-teal transition-all shadow-sm">
          ...
          <Card className="p-5 bg-brand-green text-white border-none rounded-[24px] space-y-2 shadow-xl relative overflow-hidden group">
            ...
            <div className="relative z-10 space-y-2">
              <div className="w-10 h-10 rounded-full bg-brand-gold/20 text-brand-gold flex items-center justify-center">
                <Zap size={20} />
              </div>
      ...
      {/* 03B: Energy Arc - Compact Timeline */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 animate-fade-in-up [animation-delay:400ms]">
        <div className="bg-brand-teal rounded-[24px] p-6 text-white relative overflow-hidden flex flex-col justify-center shadow-lg">
        ...
        <div className="space-y-4 flex flex-col justify-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="p-4 bg-white border border-brand-green/5 rounded-xl">
              <div className="font-headline text-2xl text-brand-teal leading-none">85%</div>
              <div className="font-body text-[7px] uppercase font-bold tracking-widest opacity-40 mt-1">Reach</div>
            </div>
            <div className="p-4 bg-white border border-brand-green/5 rounded-xl">
              <div className="font-headline text-2xl text-brand-gold leading-none">100%</div>
      ...
      <div className="space-y-4 animate-fade-in-up [animation-delay:600ms]">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-2">
          {[
            ...
            <Card key={i} className="p-3 flex flex-col items-center text-center gap-2 bg-white border border-brand-green/5 rounded-xl hover:border-brand-gold transition-all shadow-sm">
              <div className="w-8 h-8 rounded-full bg-brand-cream text-brand-gold flex items-center justify-center">
                {step.icon}
              </div>
